...
<head>
    ...
    <title>LOGIN | JEWELLERY SHOP MANAGEMENT SYSTEM</title>
    ...
    <style>
        ...
        body{
            background-image:url('./images/covermain.png') !important;
...
<body class="">
   <div class="h-100 d-flex justify-content-center align-items-center">
       <div class='w-100'>
        <h1 class="py-5 text-center text-light px-4" id="sys_title">JEWELLERY SHOP MANAGEMENT SYSTEM</h1>
