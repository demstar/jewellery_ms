<div class="card shadow rounded-0">
    <div class="card-body">
        <div class="w-100 h-100 d-flex flex-column">
            <div class="row">
                <div class="col-8">
                    <h3 style="color: black;">Transaction</h3>
                </div>
                <div class="col-4 d-flex justify-content-end">
                <button class="btn btn-sm btn-primary rounded-0" id="transaction-save-btn" type="button" style="color: black; font-weight: bold;">Save Transaction</button>
    ...
    <div class="pt-2">
        <div class="w-100 mx-0 d-flex pb-1">
            ...
            <div class="flex-grow-1 bg-light fs-6 fw-bolder text-end px-2" id="subTotal" style="color: black;">0.00</div>
        </div>
        <div class="w-100 mx-0 d-flex pb-1 align-items-center">
            ...
            <div class="flex-grow-1 bg-light fs-6 fw-bolder text-end px-2" id="tax" style="color: black;">0.00</div>
        </div>
        <div class="w-100 mx-0 d-flex pb-1">
            <div class="col-4 pe-2 fs-6 fw-bolder text-light">Total</div>
            <div class="flex-grow-1 bg-light fs-6 fw-bolder text-end px-2" id="total" style="color: black;">0.00</div>
        </div>
    </div>
</div>
