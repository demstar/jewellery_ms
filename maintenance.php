<div class="card h-100 d-flex flex-column rounded-0 shadow">
    <div class="card-header d-flex justify-content-between">
        <h3 class="card-title" style="color: black;">Maintenance</h3>
        <div class="card-tools align-middle">
            <!-- Save button inside modal triggered by the "Add New" -->
...
<!-- Add the Save Button in the modal form -->
<script>
    $(function(){
        // Category Functions
        ...
        $('#save_category').click(function(){
            // Here you can add code to validate the form and save the category data
            alert("Category saved successfully!");
            // Optionally: Send an AJAX request to save the category
        });
    })
